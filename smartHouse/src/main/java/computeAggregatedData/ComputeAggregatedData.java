...
//        temperature = TemperatureSensor.getInstance();
	...
	public void createCO2Indicator() {
		Sensor co2 = null;
		try {
			co2 = Sensors.getInstance().getSensorByString("co2");
	...
	public void createTemperatureIndicator() {
		...
		try {
			temperature = Sensors.getInstance().getSensorByString("temperature");
		} catch (NullPointerException e) {
			e.printStackTrace();
		}
	...
	public void createHumidityIndicator() {
		...
		try {
			humidity = Sensors.getInstance().getSensorByString("humidity");
		} catch (NullPointerException e) {
			e.printStackTrace();
		}
